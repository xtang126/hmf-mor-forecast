...
#SBATCH -J hmf_prior_c10_w01
#SBATCH --ntasks=21
#SBATCH --cpus-per-task=1
#SBATCH -t 08:00:00
#SBATCH --mail-user=xt52@sussex.ac.uk
#SBATCH --mail-type=ALL
#SBATCH -o /its/home/xt52/hmf-mor-forecast/log/hmf_prior_c10_w01_%j.log
#SBATCH -e /its/home/xt52/hmf-mor-forecast/log/hmf_prior_c10_w01_%j.error
